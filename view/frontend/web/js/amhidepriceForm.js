define([
    ...
    return {
        component: 'Amasty_HidePrice/js/amhidepriceForm', // Breeze fix: added component
        products: {},
        customer: null,
        selectors: {
        ...
        _showPopup: function (element) {
            ...
            if (form.modal('instance')) {
                form.modal('openModal');
            } else {
                form.modal({buttons: [], autoOpen: true}); // Breeze fix: replace fancyambox with modal
            }
        },
        ...
        submitForm: function (form) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $(result).modal({buttons: [], autoOpen: true});
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    $('body').spinner(false);
                    form.modal('closeModal');
                    $(errorThrown).modal({buttons: [], autoOpen: true});
                }
            });
        },
